...
* `user`
  ...
  Allows the Integration to proactively create a user. This is useful if the Integration needs to send a message to a user that has not yet interacted with the Bot.
